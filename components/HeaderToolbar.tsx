...
interface HeaderToolbarProps {
  ...
  onToggleEditMode: () => void; // Nowy prop
                  ...
                  <>
                    ...
                    >
                     ...
                     <button
                        ...
                        disabled={anyActionInProgress}
                        className={`px-3 py-1.5 text-xs font-semibold rounded-md transition-colors disabled:opacity-50 ${isEditing ? 'bg-indigo-600 text-white hover:bg-indigo-500' : 'bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-300 dark:hover:bg-slate-600'}`}
                    >
