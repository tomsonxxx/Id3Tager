    ...
    <div className="h-28 bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 flex items-center px-6 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] z-40 relative">
      ...
      <div className="flex flex-col items-center justify-center flex-grow max-w-4xl px-4">
        ...
        <div className="flex items-center space-x-6 mb-2">
             <button onClick={togglePlay} className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${isPlaying ? 'bg-indigo-600 text-white shadow-neon animate-pulse-glow' : 'bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-indigo-500 hover:text-white hover:shadow-neon'}`}>
                {isPlaying ? (
