      ...
      <div className="flex items-center space-x-3 md:space-x-4 flex-1">
        <div className="flex space-x-1">
            <button 
                ...
                className="flex items-center px-3 py-2 bg-indigo-600 hover:bg-indigo-500 disabled:bg-indigo-400 text-white text-sm font-bold rounded-l-md shadow-neon hover:shadow-neon-hover transition-all duration-300"
